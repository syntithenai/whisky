...
![World map for whisky-producing regions](data/images/phase-1-orientation-foundations/world-map.png)
...
![Barley seeds](data/images/phase-1-orientation-foundations/barley-seeds.jpg)
...
![Yeast fermentation](data/images/phase-1-orientation-foundations/yeast-fermentation.jpg)
...
![Pot still](data/images/phase-1-orientation-foundations/pot-still.jpg)

![Column still](data/images/phase-1-orientation-foundations/column-still.jpg)
...
![Cask warehouse](data/images/phase-1-orientation-foundations/cask-warehouse.jpg)
...
![Copper still house](data/images/phase-1-orientation-foundations/copper-stills.jpg)
...
![Wall of whisky labels](data/images/phase-1-orientation-foundations/whisky-label-wall.jpg)
...
|---|---|
| 1 | Whisky is better understood as a legal and technical category than a simple flavor style; production rules define what can be sold under each name. |
| 2 | "Single malt" means one distillery and malted barley base; it does not guarantee superior quality versus blends. |
| 3 | Maturation environment changes extraction and oxidation rates, which is why climate and warehouse style matter alongside cask type. |
| 4 | Fermentation duration and yeast behavior strongly shape fruit, cereal, and estery notes before distillation begins. |
| 5 | Distillation design affects cut points and reflux, which influences spirit weight and aromatic focus. |
| 6 | Cask history (bourbon, sherry, etc.) is one of the largest contributors to final aroma and color outcomes. |
| 7 | Reading labels critically helps separate regulated terms from marketing language that sounds technical but is not standardized. |
| 8 | Age statement only reflects the youngest component in the bottle and should be read with process and cask context. |
| 9 | Whisky/whiskey spelling follows regional convention and legal tradition, not an objective sweetness or quality scale. |
| 10 | The Law-Process-Marketing framework prevents overreliance on storytelling and keeps evaluation evidence-based. |
